...
def main():
    ...
    red_seen = False
    lasterror = error = integral = prevcourse = counter = RED_counter = course = 0
    office = []
        ...
        while(1):
            ...
            # Otherwise do what was being done before
                ...
                if(red_seen):
                    ...
                    if(current_time - red_time < 4 and office[counter] == 'L'):
                        prevcourse = operate(left, mid, 300, lasterror, integral, prevcourse, office, cur_motors)
                    elif(current_time - red_time < 4 and office[counter] == 'R'):
                        prevcourse = operate(300, mid, right, lasterror, integral, prevcourse, office, cur_motors)
                    else:
                        red_seen = False
